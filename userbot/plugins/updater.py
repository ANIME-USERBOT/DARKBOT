...
OFFICIAL_UPSTREAM_REPO = "https://github.com/ANIME-USERBOT/DARKBOT"
BOT_IS_UP_TO_DATE = "❂LegendBOT is up-to-date!❂"
NEW_BOT_UP_DATE_FOUND = (
    "**DARK BOT  Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("**﹁﹁Updating DARK BOT TO NEW VERSION* \n**Version** : `2.0` \n**Telethon** : `1.15.0` \n**Status** : `«Pulling Updates»` \n『**Thank You For Using LegendBOT !**』")
